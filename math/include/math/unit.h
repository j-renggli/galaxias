...
{
    using value_type =
        Unit<std::ratio_multiply<typename U::Time, Ratio>,
...
using Unitless = Unit<ratio::Zero,
                      ratio::Zero,
                      ratio::Zero,
                      ratio::Zero,
                      ratio::Zero,
